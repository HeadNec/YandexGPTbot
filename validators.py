...
from config import LOGS, MAX_USERS, MAX_USER_GPT_TOKENS, TOKEN, MAX_USER_STT_BLOCKS, MAX_USER_TTS_SYMBOLS
# подтягиваем функции для работы с БД
from database import count_users, count_all_limits, add_message
...
def is_stt_block_limit(user_id, duration):
    ...
    # Переводим сеstt_blocksкунды в аудиоблоки
